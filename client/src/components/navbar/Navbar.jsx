    ...
    <nav className="sticky top-0 z-50 w-full bg-bg px-3 py-4 shadow-sm after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-full after:bg-linear-to-r after:from-violet-500 after:to-fuchsia-500">
      <div className="mx-auto flex items-center justify-between">
        <div className="flex-1">
          <Link
            to="/"
            className="px-1 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset-2 focus-visible:ring-blue-600 text-2xl font-bold text-transparent bg-clip-text bg-linear-to-r from-violet-500 to-fuchsia-500"
            onClick={closeMenu}
          >
            KMQS
          </Link>
